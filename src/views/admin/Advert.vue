                ...
                <div class="content-top">
                    ...
                    <div class="modal-content bor-rad" v-if="tmp" style="width:100%;outline:none;box-shadow:none;border:none;min-width:900px;">
                        <div class="modal-header" style="position:relative;min-width:1000px;">
                            <button type="button" class="btn btn-default btn-xs" data-dismiss="modal" @click="changetmp()" style="font-size:13px;position:absolute;left:20px;top:16px;">
                            ...
                            <div style="width:100%;height:100%;max-width:1600px;min-width:800px;">
                                <span class="modal-title" id="myModalLabel" v-if="isEdit==0" style="padding-right:28%;font-size:16px;font-weight:bold;">添加{{pageLoction}}</span>
                                <span class="modal-title" id="myModalLabel" v-else style="padding-right:28%;font-size:16px;font-weight:bold;">编辑{{pageLoction}}</span>
                            </div>
                        </div>
                        <form class="form-horizontal" style="font-size:12px; " role="form">
                            <div class="modal-body" style="padding-right:25%;max-width:1600px;min-width:800px;">
                                ...
                                <div class="text-right">
                                    <button type="button" class="btn btn-default" data-dismiss="modal" @click="changetmp()">返回列表</button>
                                    <button type="button" class="btn btn-primary color-blue" @click="httpreq('11102')" v-if="isEdit==0">提交添加</button>
                                    <button type="button" class="btn btn-primary color-blue" @click="httpreq('11108')" v-else-if="isEdit==1">提交更改</button>
                                </div>
                            </div>
                        </form>
                    </div>
                    ...
                    <div v-if="!tmp">
                        <div class="content-sub">
                            ...
                            <span>
                                ...
                                <button type="button" class="btn btn-primary btn-sm c-blue" @click="httpreq('11107')" style="position:absolute;right:25px;top:18px;">搜索</button>
                            </span>
                        </div>
                        ...
                        <div class="modal-content bor-rad" v-if="tmp" style="width:100%;outline:none;box-shadow:none;border:none">
                            <div class="modal-header">
                                <h5 class="modal-title" id="myModalLabel" v-if="isEdit==0" style="padding-right:28%;font-size:17px;">添加{{pageLoction}}</h5>
                                <h5 class="modal-title" id="myModalLabel" v-else style="padding-right:28%;font-size:17px;">编辑{{pageLoction}}</h5>
                            </div>
                            <form class="form-horizontal" style="font-size:12px; " role="form">
