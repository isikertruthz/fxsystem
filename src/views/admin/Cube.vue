            ...
            <div class="content">
                <div class="content-top">
                    <div class="text-left padding-25">
                        ...
                        <div class="alert alert-primary bor-rad" style="margin: 10px 0;height:46px;padding:13px 15px;">提示：拖动改变位置，最多添加4个，请参照上图。删除操作不需再保存。图片路径和链接的值为空将不保存。</div>
                                    ...
                                    <td>
                                        <div class="input-group img-item">
                                            <div class="input-group-addon" style="padding: 0 5px;background-color:white;border-radius: 0;">
                                                <img :src="item.imgpath==''?imgtmp==''?'http://localhost/imgdef.png':imgtmp:'http://localhost/upload/'+item.imgpath" style="height:20px;width:20px">
                                            </div>
                                            <input type="text" class="form-control" name="" :value="item.imgpath" style="height:34px;" disabled>
                                            <div class="input-group-btn">
                                                <input type="file" name="file" :id="'file'+item.id" @change="fileUpload($event,item.id)" style="display:none;">
                                                <button type="button" @click="selectPic('file'+item.id)" class="btn btn-default btn-select-pic bor-rad">选择图片</button>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                        ...
                        <div>
                            <button class="btn btn-primary btn-sm c-blue" style="background-color:#44abf7;height:28px;" @click="httpreq('11302')">保存</button>
